...
The Linux TUI also uses a minimum recursion limit of 256 for the embedded app-server request future. This matches the existing Windows build adjustment, preserves higher upstream limits, and is checked for repeatability in the compatibility tests.
